...
export default function YeniTalepScreen() {
    ...
    const talepGonder = async () => {
        ...
        try {
            ...
            if (result.success) {
                // Adminlere bildirim gönder (Client-side notification removed due to security rules)
                // Admins should monitor the pool or use cloud functions for notifications.
